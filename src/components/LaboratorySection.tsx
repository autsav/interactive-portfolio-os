...
import { FlaskConical, Terminal, Binary, Cpu, Share2, Play } from "lucide-react";
            ...
            <div className="p-6 border-b" style={{ borderColor: "var(--border)" }}>
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="mono text-[9px] uppercase" style={{ color: wf.status === 'active' ? 'var(--green)' : 'var(--fg-muted)' }}>{wf.status}</span>
                </div>
              </div>
              <h3 className="text-xl font-bold mb-1" style={{ color: "var(--fg)" }}>{wf.title}</h3>
              <p className="mono text-[10px]" style={{ color: "var(--orange)" }}>{wf.tech}</p>
            </div>

            {/* Terminal Mockup */}
            <div className="bg-black/40 p-5 font-mono text-[11px] flex-1 min-h-[140px]">
              ...
              <div className="mt-2 flex gap-2">
                ...
                <span className="text-neutral-600 italic">awaiting feedback...</span>
              </div>
            </div>
